...
user = {
    ...
    openweathermap_key = "3650d93df6b9e127617dae55832af39c",
    openweathermap_city_id = "1850147",
...
awful.rules.rules = {
    ...
    -- Fixed terminal geometry for floating terminals
    {
        ...
        properties = { width = screen_width , height = screen_height }
    },
